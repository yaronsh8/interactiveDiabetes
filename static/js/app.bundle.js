...
__WEBPACK_IMPORTED_MODULE_1_jquery___default()(document).ready(function () {
    ...
    var animBg = document.getElementById("animBG"),
        jqSugarRange = __WEBPACK_IMPORTED_MODULE_1_jquery___default()('.sugarRange'),
        jsSugarValue = __WEBPACK_IMPORTED_MODULE_1_jquery___default()('.sugarValue'),
        jsExplanation = __WEBPACK_IMPORTED_MODULE_1_jquery___default()('.explanation'),
        jsInstruction = __WEBPACK_IMPORTED_MODULE_1_jquery___default()('.instruction'),
        jsAnim = __WEBPACK_IMPORTED_MODULE_1_jquery___default()('#anim'),
        isDiabetec = false,
        isDiabetecPrev = null,
    ...
    jqSugarRange.change(function (e) {
        if (e.currentTarget.value > 126) {
            if (isDiabetec == true) {
                ...
                isDiabetec = true;
                __WEBPACK_IMPORTED_MODULE_1_jquery___default()('.glucose').addClass("fadeOut");
                __WEBPACK_IMPORTED_MODULE_1_jquery___default()('.insulin').addClass("disappear");
            ...
            if (isDiabetec == false) {
                ...
                isDiabetec = false;
                __WEBPACK_IMPORTED_MODULE_1_jquery___default()('.cell.fatigued').removeClass('fatigued');
                __WEBPACK_IMPORTED_MODULE_1_jquery___default()('.glucoseBox.diabetec').find(".glucose").addClass("fadeOut");
                ...
                setTimeout(function () {
                    __WEBPACK_IMPORTED_MODULE_1_jquery___default()('.glucoseBox.diabetec').remove();
                }, 1000)
            }
        }
        clearTimeout(elementCreationControl);
        playAnimation();
        __WEBPACK_IMPORTED_MODULE_1_jquery___default()(".expText").toggleClass('hidden');
    ...
    function removeGlucose(glucoseBox) {
        ...
        setTimeout(function () {
            __WEBPACK_IMPORTED_MODULE_1_jquery___default()(glucoseBox).remove();
        }, 2000);
    ...
    function removeInsulin(insulinBox) {
        ...
        setTimeout(function () {
            __WEBPACK_IMPORTED_MODULE_1_jquery___default()(insulinBox).remove();
        }, 2000);
